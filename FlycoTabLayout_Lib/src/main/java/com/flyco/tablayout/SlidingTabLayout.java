...
public class SlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    private float mIndicatorWidthEqualTitleOffset;
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mIndicatorWidthEqualTitleOffset = ta.getDimension(R.styleable.SlidingTabLayout_tl_indicator_width_equal_title_offset, dp2px(0));
...
//            v.setPadding((int) mTabPadding, v.getPaddingTop(), (int) mTabPadding, v.getPaddingBottom());
            ...
            if (tv_tab_title != null) {
                if(tabColors != null && tabColors.size() == mTabCount){
                    //如果指定的具体的颜色则选择色失效
                    tv_tab_title.setTextColor(tabColors.get(i));
                }else{
    ...
    public void onPageSelected(int position) {
        ...
        if(tabColors != null && tabColors.size()==mTabCount){
            mIndicatorColor = tabColors.get(position);
        }
    }
    ...
    private void updateTabSelection(int position) {
        for (int i = 0; i < mTabCount; ++i) {
            ...
            if (tab_title != null) {
                if(tabColors != null && tabColors.size() == mTabCount){
                    tab_title.setTextColor(tabColors.get(i));
                }else{
    ...
    private void calcIndicatorRect() {
        ...
        //for mIndicatorWidthEqualTitle
        if (mIndicatorStyle == STYLE_NORMAL && mIndicatorWidthEqualTitle) {
            mIndicatorRect.left = (int) (left + margin - mIndicatorWidthEqualTitleOffset - 1);
            mIndicatorRect.right = (int) (right - margin + mIndicatorWidthEqualTitleOffset - 1);
        }
    ...
    public void setTabColors(List<Integer> tabColors) {
